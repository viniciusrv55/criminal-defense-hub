    ...
    <footer className="bg-card border-t border-border">
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <h4 className="font-serif text-lg font-semibold mb-6 text-foreground">Links Rápidos</h4>
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}><Link to={link.href} className="text-muted-foreground hover:text-gold transition-colors text-sm">{link.label}</Link></li>
              ))}
            </ul>
          </div>

          <div>
            <h4 className="font-serif text-lg font-semibold mb-6 text-foreground">Áreas de Atuação</h4>
            <ul className="space-y-3">
              {["Direito Penal", "Defesa Criminal", "Habeas Corpus", "Audiência de Custódia", "Execução Penal"].map(area => (
                <li key={area}><span className="text-muted-foreground text-sm">{area}</span></li>
              ))}
            </ul>
          </div>

          <div>
            <h4 className="font-serif text-lg font-semibold mb-6 text-foreground">Contato</h4>
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-gold flex-shrink-0 mt-0.5" />
                <span className="text-muted-foreground text-sm">{settings.address || 'Av. Paulista, 1000 - Sala 1010\nSão Paulo, SP - Brasil'}</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-muted-foreground text-sm">{settings.email || 'contato@lindombertomoraes.adv.br'}</span>
              </li>
              <li className="flex items-center gap-3">
